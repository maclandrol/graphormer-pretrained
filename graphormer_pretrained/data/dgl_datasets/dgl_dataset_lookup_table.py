...
from graphormer_pretrained.data.dgl_datasets.dgl_dataset import GraphormerDGLDataset
...
class DGLDatasetLookupTable:
    ...
    def GetDGLDataset(dataset_name: str, seed: int) -> Optional[DGLDataset]:
        ...
        return (
            None if inner_dataset is None else GraphormerDGLDataset(inner_dataset, seed)
        )
